...
export function DirectorCard({
  ...
  const content = (
    <Card className="group py-0 flex h-full flex-col items-center overflow-hidden border border-border/40 bg-card/80 text-center shadow-md transition-colors duration-300 hover:border-[#3B5998]/60">
      ...
      <CardContent className="flex flex-1 justify-between flex-col items-center gap-3 pt-5 pb-4 px-4 w-full">
        <div className="space-y-2 w-full">
          ...
          <div className="inline-block rounded-full border border-[#3B5998]/30 bg-[#3B5998]/10 px-3 py-1">
