...
export function DirectorCard({
  ...
  const content = (
    <Card className="group flex h-full flex-col items-center overflow-hidden border border-border/40 bg-card text-center shadow-md transition-all duration-500 ease-out hover:-translate-y-2 hover:scale-[1.02] hover:border-[#3B5998]/60 hover:shadow-2xl">
